...
export const ComponentSectionsHeroFragmentFragmentDoc = gql`
  ...
  image {
    ...
    `;
export const GetContentPagesDocument = gql`
  ...
  contentPages {
    ...
    ${ComponentSectionsHeroFragmentFragmentDoc}`;

/**
 * __useGetContentPagesQuery__
 *
 * To run a query within a React component, call `useGetContentPagesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetContentPagesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetContentPagesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetContentPagesQuery(baseOptions?: Apollo.QueryHookOptions<GetContentPagesQuery, GetContentPagesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetContentPagesQuery, GetContentPagesQueryVariables>(GetContentPagesDocument, options);
      }
export function useGetContentPagesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetContentPagesQuery, GetContentPagesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetContentPagesQuery, GetContentPagesQueryVariables>(GetContentPagesDocument, options);
        }
export function useGetContentPagesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetContentPagesQuery, GetContentPagesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetContentPagesQuery, GetContentPagesQueryVariables>(GetContentPagesDocument, options);
        }
export type GetContentPagesQueryHookResult = ReturnType<typeof useGetContentPagesQuery>;
